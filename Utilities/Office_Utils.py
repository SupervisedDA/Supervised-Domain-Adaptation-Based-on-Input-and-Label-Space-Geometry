...
class MyOffice(datasets.VisionDataset):
    """
    Colored USPS dataset for testing IRM. Prepared using procedure from https://arxiv.org/pdf/1907.02893.pdf
    ...
    def __init__(self, rect_loader, transform=None):
        ...
        # self.samples_list=[self.train[x] for x in range(len(self.train))]
        tmp = ['back_pack',
               'bike',
               'bike_helmet',
               'bookcase',
    ...
    def __len__(self):
        # return max(len(self.data_label_tuples), self.BatchSize)
...
class OfficeArgsClass():
    def __init__(self, ):
        ...
        self.root = '/mnt/nfs/ori/TestTF/examples/domain_adaptation/image_classification/data/office31'
        self.batch_size = 32
        self.workers = 2
        self.arch = 'resnet50'
        self.scratch = False
